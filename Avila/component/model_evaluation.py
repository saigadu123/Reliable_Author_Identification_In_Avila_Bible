...
from Avila.entity.config_entity import ModelEvaluationConfig
from Avila.entity.artifact_entity import DataIngestionArtifact
from Avila.entity.artifact_entity import DataValidationArtifact
from Avila.entity.artifact_entity import ModelTrainerArtifact
from Avila.entity.artifact_entity import ModelEvaluationArtifact
from Avila.constant import * 
import os,sys
import numpy as np
from Avila.util.util import load_object, read_yaml_file,write_yaml_file,load_data
from Avila.entity.model_factory import MetricInfoArtifact,evaluate_classification_model
...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            logging.info(f"{self.data_ingestion_artifact.train_file_path}")
            #Extracting Data
